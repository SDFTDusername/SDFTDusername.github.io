class AppComponent extends HTMLElement {
    constructor() {
        ...
        const url = this.getAttribute("url") || `/legacy/apps/${app}.html`; // what url to open if type is openurl or redirecturl

        const iconUrl = `/legacy/src/img/apps/${app}.png`;
        ...
        style.href = "/legacy/src/css/style.css";
...
const homebuttonPressSound = new Audio("/legacy/src/sounds/homebutton-press.mp3");
const homebuttonReleaseSound = new Audio("/legacy/src/sounds/homebutton-release.mp3");
...
function homeButtonPress(event: Event) {
...
function homeButtonRelease(event: Event) {
    if (!homeButtonPressed)
        return;
